...
"""
    ...
    async def _execute_output_tags(
        ...
        Called after the agent result is sent. Handles TTS, maps, email,
        GitHub writes, KB saves/updates, config updates, mutes, reminders,
        sub-task spawning, and orchestration.
        """
        all_tts = tc.tts
        all_maps = tc.maps
